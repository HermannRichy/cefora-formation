          ...
          <div className="max-w-[900px] mx-auto">
            <div className="mb-10 max-w-[500px] mx-auto text-center sm:mx-0 sm:text-left">
              ...
              <div className="text-gray-700 text-base space-y-3">
                <p>
                  Chez{' '}
                  <span className="font-semibold text-[#232C64]">CEFORA</span>{' '}
                  <span className="font-semibold text-[#DB3234]">
                    FORMATION
                  </span>
                  , nous façonnons l’avenir de nos apprenants grâce à des
                  formations pratiques, innovantes et tournées vers l’emploi.
                </p>
                <p>
                  Nos parcours vous rendent autonomes, compétitifs et prêts à
                  réussir, ici comme à l’international. Commencez à Cotonou,
                  progressez en Afrique et en Europe grâce à nos partenariats.
                </p>
              </div>
            </div>
          </div>
